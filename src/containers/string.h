...
inline void string_copy_into(String& dest, const String& src)
{
    // WARNING! This can end up reading outside the allocated memory
    platform_copy_memory(dest.data, src.data, src.size);
    dest.size = src.size;
